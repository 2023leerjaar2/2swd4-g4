...
<body>
    ...
    <main>
        <form class="form" method="POST" action="login.php">
            ...
            <div class="inputs">
                <input name="gebruikersnaam" placeholder="Gebruikersnaam" class="input" type="text" required>
                <input name="wachtwoord" placeholder="Password" class="input" type="password" required>
